...
func main() {
	...
	incoming_message_chan := SubscribeMultipleAndForwardToChannel(mqttc, []string{
		...
		r3events.TOPIC_ESPHOME_R2W2_TEMPERATURE,
		r3events.TOPIC_ESPHOME_R2W2_BAROMETER,
		r3events.TOPIC_ESPHOME_REDOXNH3_TEMPERATURE,
		r3events.TOPIC_ESPHOME_REDOXNH3_BAROMETER,
		r3events.TOPIC_ESPHOME_REDOXNH3_HUMIDITY,
